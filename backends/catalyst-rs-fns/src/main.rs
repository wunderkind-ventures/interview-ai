        ...
        let model_path = match &self.model {
            ...
            None => {
                let (repo, filename, revision) = match self.which {
                    ...
                    Which::Q2_K => ("calcuis/chatterbox-gguf", "t3_cfg-q2_k.gguf", "main"),
                    Which::Q4_K_M => ("calcuis/chatterbox-gguf", "t3_cfg-q4_k_m.gguf", "main"),
                    Which::Q6_K => ("calcuis/chatterbox-gguf", "t3_cfg-q6_k.gguf", "main"),
                    Which::Q16 => ("calcuis/chatterbox-gguf", "ve_fp32-f16.gguf", "main")
                    Which::Q32 => ("calcuis/chatterbox-gguf", "ve_fp32-f16.gguf", "main"),
                };
                let api = hf_hub::api::sync::Api::new()?;
