...
export const CustomizeInterviewQuestionsInputSchema = z.object({
  ...
  interviewType: z
    .enum(['product sense', 'technical system design', 'behavioral', 'machine learning'])
