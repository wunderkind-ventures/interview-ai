...
**Final Output Format:**
Your response will be a JSON object with a single key "jsonString".
The value of "jsonString" MUST be a valid JSON string that can be parsed into an object with the following fields:
