...
import type { InterviewType, InterviewStyle } from '@/lib/types'; // Assuming these types exist in lib/types
...
export const RefineInterviewFeedbackInputSchema = z.object({
  draftFeedback: GenerateInterviewFeedbackOutputSchema.describe( // Use the imported schema from ../schemas
